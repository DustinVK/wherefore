...
- If `wherefore/topics.md` does NOT exist: create the `wherefore/` directory (plus an empty
  `INDEX.md` if missing) and write the confirmed vocabulary as `wherefore/topics.md`
  in the two-section format above.
